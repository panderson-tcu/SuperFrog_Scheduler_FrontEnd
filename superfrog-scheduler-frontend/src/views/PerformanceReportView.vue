  ...
  <div id="wrapper">
    ...
    <div id="main-col">
      ...
      <div
        ...
        "
      >
        <h1>Superfrog Student Performance Report</h1>
        ...
        <div style="margin-top: 10px">
          <button @click="showPopup">GENERATE PERFORMANCE REPORT</button>
        </div>
        ...
        <div>
          ...
          <div class="popup" v-if="popup" style="">
            ...
            <h2
              ...
              "
            >
              Super Frog Student Performance Report
            </h2>
            <table
              style="
                width: 80%;
            ...
            >
              ...
              <thead>
                <tr>
                  ...
                  <th>Begin</th>
                  <th>End</th>
                  <th>Number of Completed Appearances</th>
                </tr>
              </thead>
              <!--table body-->
              <tbody>
                <tr v-for="(item, index) in performanceReports" :key="index">
                  <td>{{ item.reportId }}</td>
                  <td>{{ item.firstName }}</td>
                  <td>{{ item.lastName }}</td>
                  <td>{{ beginDate }}</td>
                  <td>{{ endDate }}</td>
                  <td>{{ item.numberOfCompletedAppearances }}</td>
                </tr>
              </tbody>
            </table>
